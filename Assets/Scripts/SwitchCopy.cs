...
public class SwitchCopy : MonoBehaviour {
	...
	void Awake () {
		FuseC = Switch.GetComponent<NeoSwitch> ().SwitchColor;
		...
		Scale = transform.localScale.x / 4;
	}
